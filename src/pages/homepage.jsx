  ...
  return (
    <div className="relative ">
      ...
      <img
        ...
        src={rollerImage}
        alt="roller"
        className="fixed -bottom-[50%] max-w-[140vw] -left-[20vw]   lg:top-[75vh]  lg:max-w-[40vw] lg:left-[30vw]      opacity-0 translate-y-full z-[20] !origin-center"
      />
      {/* xl:-bottom-[90%]  xl:max-w-[60vw]    xl:left-[20vw]  */}
